...
# this hides the cmd window we named as below!
...
def getImage(patinfo):
    desired_size = 512
    src = app.config['WADOServer'] + "studies/" +  patinfo["StudyUID"]+ "/series/"+ patinfo["SeriesUID"] +"/instances/"+patinfo["InstanceUID"]+"/frames/1/rendered"
...
def inference():
    ...
    return "OK"
    #return eval1.startinf(request.get_json(), getImage(request.get_json()))
